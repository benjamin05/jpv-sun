...
class TwoDatesSelectionFilterbyEmployeeDialog extends JDialog {
  ...
  TwoDatesSelectionFilterbyEmployeeDialog( ) {
    buildUI()
  }
    ...
    sb.dialog( this,
      ...
      panel() {
        ...
        panel( constraints: BorderLayout.CENTER, layout: new MigLayout( "wrap 2", "20[][grow,fill]40", "20[]10[]" ) ) {
          ...
          label( text: " " )
          cbResume = checkBox( text: "Corte por Empleado", selected: true )
